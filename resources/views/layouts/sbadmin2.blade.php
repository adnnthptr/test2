    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Klinik Dokter <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ url('pasien/laporan/cetak', []) }}" target="_blank">Laporan
                            Pasien</a>
                        <a class="collapse-item" href="{{ url('dokter/laporan/cetak', []) }}" target="_blank">Laporan
                            Dokter</a>
                        <a class="collapse-item" href="{{ url('administrasi/laporan/cetak', []) }}"
                            target="blank">Laporan
                            Administrasi</a>
